...
const CERTS = [
  {
    ...
    body: "FreeCodeCamp / Self-paced",
  },
  { year: "2024", title: "React Native — The Practical Guide", body: "FreeCodeCampm" },
  { year: "2023", title: "Basics of Web Devlopment", body: "FreeCodeCamp" },
];
...
export default function Portfolio() {
  ...
  useEffect(() => {
    const saved =
      typeof window !== "undefined" && localStorage.getItem("ajay-theme");
  ...
  useEffect(() => {
    ...
    r.style.setProperty(
      "--muted",
      d ? "rgba(240,237,230,0.42)" : "rgba(26,18,8,0.52)",
    );
    r.style.setProperty(
      "--dim",
      d ? "rgba(240,237,230,0.18)" : "rgba(26,18,8,0.26)",
    );
    r.style.setProperty(
      "--border",
      d ? "rgba(240,237,230,0.09)" : "rgba(26,18,8,0.1)",
    );
    r.style.setProperty(
      "--ghost",
      d ? "rgba(240,237,230,0.042)" : "rgba(26,18,8,0.05)",
    );
    r.style.setProperty(
      "--tag-bg",
      d ? "rgba(240,237,230,0.055)" : "rgba(26,18,8,0.06)",
    );
    r.style.setProperty(
      "--glass-bg",
      d ? "rgba(17,16,9,0.65)" : "rgba(240,236,227,0.65)",
    );
    r.style.setProperty(
      "--glass-bdr",
      d ? "rgba(240,237,230,0.07)" : "rgba(26,18,8,0.07)",
    );
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        :root{
          ...
          --sw:46px;   /* left icon strip */
          --rw:20px;   /* right marquee strip */
          --nw:148px;  /* nav column width — fixed, never grows */
        }
        /* only transition color/border, NOT background on all divs (prevents black flash) */
        ...
        /* ── COMPACT NAV — sits right of the strip, transparent bg ── */
        #ln{
          position:fixed;
          left:var(--sw);           /* flush against the strip edge */
          top:50%;
          transform:translateY(-50%);
          z-index:190;              /* below strip so resume tab overlaps cleanly */
          display:flex;
          flex-direction:column;
          gap:0px;
          width:var(--nw);
          background:transparent;  /* NO background — completely see-through */
        ...
        .nav-label{
          font-size:11px;
          font-weight:700;        /* BOLD like the reference */
          letter-spacing:.15em;
        }
        ...
        /* ── CONTENT: only offset by the icon strip + small gap ──
           Nav floats transparently over the left edge of content.
           Content starts right after the strip, nav is narrow enough not to cover real text. */
        .c{
      ...
      <div id="tc">
        ...
        <button
          className="ibtn"
          onClick={() =>
            window.open("https://github.com/AJayvarman0626", "_blank")
          }
        >
          <TermIcon />
        </button>
      ...
      <aside id="sl">
        ...
        >
          {[
            ...
            {
              href: "https://linkedin.com/in/ajayvarman-26x/",
              el: <LinkedinIcon />,
            },
          ].map(({ href, el }) => (
            <a
      ...
      {/* ══ COMPACT BOLD NAV (desktop only, transparent bg) ══ */}
      <nav id="ln">
        {NAV_ITEMS.map((item) => {
      ...
      >
        ...
        <a
          href="https://github.com/AJayvarman0626"
          target="_blank"
          rel="noopener noreferrer"
          className="ibtn ha"
        ...
        <a
          href="mailto:ajayvarmank@zohomail.in"
          className="ibtn ha"
          style={{ flexShrink: 0, color: "var(--muted)" }}
        >
          <MailIcon />
      ...
      {/* ══ MOBILE BOTTOM NAV (mobile only — hidden on desktop) ══ */}
      <nav
        id="mbot"
        className="mbot-glass"
        style={{
          position: "fixed",
          bottom: 0,
          left: 0,
      ...
      <div className="c">
        ...
        >
          ...
          >
            ...
            >
              {["SOFTWARE", "Developer", "Building on", "the Web"].map(
                (line, i) => (
                  <span key={i} className="clip">
                    <span
                      className={`clip-i${entered ? " in" : ""}`}
                      style={{
            ...
            >
              <span style={{ color: "var(--accent)" }}>—</span>&nbsp;Since
              2022&nbsp;
              <span style={{ color: "var(--accent)" }}>—</span>&nbsp;Tirupathur,
              TN
            </p>
            ...
            >
              <button className="bf" onClick={() => scrollTo("projects")}>
                View Projects
              </button>
              <a
                href="mailto:ajayvarmank@zohomail.in"
        ...
        >
          ...
          >
            ...
            >
              © 2026 Ajayvarman K — Tirupathur, TN
            </p>
            <p
              style={{
                fontFamily: "var(--font-mono)",
